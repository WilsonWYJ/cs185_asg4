...
//     const onSubmit = info => {
//         firebase.database.ref('/').setData(info);
//         this.ref.name.value = "";
//         this.ref.description.value = "";
//         this.ref.message.value = "";
//         this.ref.viewable.value = "";
//         this.ref.email.value = "";
//     };

//     return (
//         <div>
//             <h1>Tell Something to Me!</h1>
//             <div class="questions">
//                 <form onSubmit={handleSubmit(onSubmit)} class="qform">
...
//                     <label>Offer a short description of yourself.
//                     <input
//                     type="text"
//                     name="description"
...
//                     <label>What have you to say?
//                     <input
//                     type="text"
//                     name="message"
//                     ref={register({ required: true, maxLength: 500, minLength: 15 })}
//                     />
//                     </label>

//                     <label>Would you like your name and meesage to be viewable by the other guests of this site?
//                     <select name="viewable" ref={register({ required: true })}>
//                     <option value="Yes">Yes</option>
//                     <option value="No">No</option>
//                     </select>
//                     </label>
                    
//                     <label>If you would like me to be able to contact you, what is your email? (Email will not be posted)
//                     <input
//                     type="text"
//                     name="email"
